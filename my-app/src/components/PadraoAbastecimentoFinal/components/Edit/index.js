...
import comLoading from 'Commons/CustomLoading';
import comMsg from 'Commons/CustomMsg';

function Popup(props) {
  const { editar, setDadosForm, dadosForm } = React.useContext(IndexContext);
    ...
    <div className="teste popup">
      <div className="popu-iner">
        <div className="popup-header">
          <button className="botaoX" onClick={() => {props.setTriger(false);}}>X</button>
        </div>
...
export default comLoading(comMsg(Popup));
