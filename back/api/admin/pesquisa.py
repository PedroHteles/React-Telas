...
def pesquisa_banco(id_cda,veiculos,id_cda0,conn):
    if type(id_cda) == int and type(veiculos) == int:
        if id_cda0 == False:
            if veiculos == 0 and id_cda == 0:
                ...
                result = conn.execute(f'''SELECT cpa1.id_cda_padrao_abastec, cpa1.id_cda, cpa1.id_modelo_veiculo,modelo_veiculos.descricao veiculo_descricao , cdas.descricao cda_descricao,cpa1.qtd_litros_abastec_padrao,cpa1.media_padrao FROM cda_padrao_abastecimentos cpa1 inner join cdas on cdas.id_cda =  cpa1.id_cda and cdas.id_cda = {id_cda} inner join modelo_veiculos on cpa1.id_modelo_veiculo  =  modelo_veiculos.id_modelo and cpa1.qtd_litros_abastec_padrao != 0 and cpa1.media_padrao !=0''')
                return result.all()
            elif id_cda == 0:
                result = conn.execute(f'''SELECT cpa1.id_cda_padrao_abastec, cpa1.id_cda, cpa1.id_modelo_veiculo,modelo_veiculos.descricao veiculo_descricao , cdas.descricao cda_descricao,cpa1.qtd_litros_abastec_padrao,cpa1.media_padrao FROM cda_padrao_abastecimentos cpa1 inner join cdas on cdas.id_cda =  cpa1.id_cda inner join modelo_veiculos on cpa1.id_modelo_veiculo  =  modelo_veiculos.id_modelo and modelo_veiculos.id_modelo = {veiculos} and cpa1.qtd_litros_abastec_padrao != 0 and cpa1.media_padrao !=0''')
                return result.all()
            else:
                result = conn.execute(f'''SELECT cpa1.id_cda_padrao_abastec, cpa1.id_cda, cpa1.id_modelo_veiculo,modelo_veiculos.descricao veiculo_descricao , cdas.descricao cda_descricao,cpa1.qtd_litros_abastec_padrao,cpa1.media_padrao FROM cda_padrao_abastecimentos cpa1 inner join cdas on cdas.id_cda =  cpa1.id_cda and cpa1.id_cda = {id_cda} inner join modelo_veiculos on cpa1.id_modelo_veiculo  =  modelo_veiculos.id_modelo and modelo_veiculos.id_modelo = {veiculos} and cpa1.qtd_litros_abastec_padrao != 0 and cpa1.media_padrao !=0''')
                return result.all()
        elif id_cda0 == True:
            if veiculos == 0 and id_cda == 0:
